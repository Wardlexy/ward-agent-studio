...
export const AGENT_CONFIGS: Record<string, { color: string; emoji: string; title: string }> = {
  ...
  'station-ops-captain':   { color: '#d8a05f', emoji: '🛰️', title: 'Portfolio Curator' },
  'station-systems-engineer': { color: '#63d7ff', emoji: '🛠️', title: 'Builder' },
  'station-coordinator':   { color: '#f2d29b', emoji: '🧭', title: 'Coordinator' },
  'station-mission-specialist': { color: '#b7e5ff', emoji: '🔭', title: 'Researcher' },
  'station-field-tech':    { color: '#8bdcff', emoji: '🚀', title: 'Tester' },
  'career-agent':          { color: '#f8b4d9', emoji: '💼', title: 'Career Agent' },
  'portfolio-curator':     { color: '#d8a05f', emoji: '🛰️', title: 'Portfolio Curator' },
