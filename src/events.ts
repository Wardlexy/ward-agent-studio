...
export const RANDOM_EVENTS: RandomOfficeEvent[] = [
  {
    id: 'fire-drill',
    name: 'Reset Drill',
    slackAnnouncement: '🚨 Reset drill! Step away from the task for a second.',
    duration: 6000,
    type: 'all-move',
    targetPosition: { x: 114, y: 105 },
    managerMessage: 'Quick reset. Then back to the mission.',
    agentMessages: ['saving notes first', 'good pause actually', 'stretch break', 'resetting context'],
    sound: 'alarm',
  },
  {
    id: 'pizza',
    name: 'Energy Break',
    slackAnnouncement: '🍕 Energy break. Snacks in the galley.',
    duration: 5000,
    type: 'all-move',
    targetPosition: { x: 114, y: 105 },
    managerMessage: 'Take fuel. Then we build.',
    agentMessages: ['snack acquired', 'tiny break, big comeback', 'coffee plus snacks', 'back in five'],
    sound: 'celebration',
  },
  {
    id: 'standup',
    name: 'Mission Check',
    slackAnnouncement: '📢 @here Mission check: what is the next useful step?',
    duration: 7000,
    type: 'all-move',
    targetPosition: { x: 411, y: 417 },
    managerMessage: 'Keep it small. Keep it real.',
    agentMessages: ['one screen first', 'research done', 'design is clean', 'testing the flow', 'notes saved'],
    sound: 'notification',
  },
  {
    id: 'deploy',
    name: 'Launch Prep',
    slackAnnouncement: '🚀 Launch prep: checking the smallest usable version.',
    duration: 5000,
    type: 'slack-only',
    managerMessage: 'Do the calm checklist.',
    agentMessages: ['checking README', 'testing the main flow', 'screenshot ready', 'one bug left', 'release notes drafted'],
    sound: 'notification',
  },
  {
    id: 'deploy-success',
    name: 'Mission Shipped',
    slackAnnouncement: '✅ Mission shipped. Small win logged.',
    duration: 3000,
    type: 'slack-only',
    managerMessage: 'Nice. Save what worked.',
    agentMessages: ['small win', 'ship it', 'notes archived', 'next idea unlocked'],
    sound: 'celebration',
  },
  {
    id: 'deploy-fail',
    name: 'Build Check Failed',
    slackAnnouncement: '💥 Build check failed. Rolling back to the last clean step.',
    duration: 4000,
    type: 'slack-only',
    managerMessage: 'No drama. Find the cause.',
    agentMessages: ['checking logs', 'reproducing it', 'probably scope creep', 'reverting the messy bit', 'try again smaller'],
    sound: 'error',
  },
  {
    id: 'power-flicker',
  ...
  },
  {
    id: 'birthday',
    name: 'Milestone',
    slackAnnouncement: '🎂 Milestone reached. Tiny celebration in the lab.',
    duration: 4000,
    type: 'all-move',
    targetPosition: { x: 287, y: 129 },
    managerMessage: 'Mark the progress.',
    agentMessages: ['progress is progress', 'save the screenshot', 'write the lesson down', 'small celebration'],
    sound: 'celebration',
  },
  {
    id: 'who-broke-build',
    name: 'Scope Creep Alert',
    slackAnnouncement: '🔴 Scope creep detected. The project is getting too big.',
    duration: 5000,
    type: 'slack-only',
    managerMessage: 'Cut it back to one useful action.',
    agentMessages: ['remove nice-to-have', 'one screen first', 'save bonus ideas for later', 'MVP only'],
    sound: 'error',
  },
  {
    id: 'friday',
